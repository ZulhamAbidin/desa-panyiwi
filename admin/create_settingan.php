...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error_message)) {
        ...
        header("Location: create_settingan.php");
        exit();
    }
}
?>
...
<div class="page-header">
    <h1 class="page-title">Komponen Gaji Pegawai</h1>
</div>

<div class="card">
    <div class="card-body">
        <form action="create_settingan.php" method="post" onsubmit="convertToNumberBeforeSubmit()">
            <div class="mb-3">
                ...
                <select class="form-control select2" id="pegawai_id" name="pegawai_id[]" multiple="multiple" required>
                    <?php
                    $result = $koneksi->query("SELECT p.id, p.nama FROM pegawai p LEFT JOIN gaji_otomatis g ON p.id = g.pegawai_id WHERE g.pegawai_id IS NULL");
